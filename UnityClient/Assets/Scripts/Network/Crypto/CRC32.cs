...
namespace NGE.Crypto
{
    ...
    public sealed class CRC32
    {
        ...
        public void ComputeCRC32(int bval)
        {
            crc ^= CrcSeed;
        ...
        public void ComputeCRC32(byte[] buffer)
        {
            ComputeCRC32(buffer, 0, buffer.Length);
        }

        public void ComputeCRC32(byte[] buf, int off, int len)
        {
            crc ^= CrcSeed;
