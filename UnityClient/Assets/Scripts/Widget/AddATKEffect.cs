...
public class AddATKEffect : IWidget
{
    ...
    IEnumerator Coroutine_LoadEffectObj()
    {
        ...
        IEnumerator e = PoolManager.Singleton.Coroutine_Load(GameData.GetEffectPath("ef-all-diaoluo-buff-gongji"), data);
        while (true)
        {
            e.MoveNext();
            if (data.m_isFinish)
    ...
    public override void Release()
    {
        ...
        IPoolWidget<AddATKEffect>.ReleaseObj(this);
    }
    //彻底销毁所有资源
