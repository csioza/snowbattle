...
public class Node
{
    ...
    {
        Reset(indexX, indexY, height, idValue, xcoord, zcoord, w, p);
    }
    public void Reset(int indexX, int indexY, float height, int idValue, float xcoord, float zcoord, bool w, Node p = null)
    {
        x = indexX;
        y = indexY;
        yCoord = height;
